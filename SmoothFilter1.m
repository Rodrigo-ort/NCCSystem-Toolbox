% Function name....: SmoothFilter1
% Date.............: Feb 01, 2018
% Mod date.........: Jun 16, 2019
...
%                    sample frequency
function [y3] = SmoothFilter1(x, y, plotFlag, signalLabel, cutOff)
...
if plotFlag
    ...
    hline = refline([0 0]);
    hline.Color = 'k';
    title('Original signal - Rloess','FontSize',18);
